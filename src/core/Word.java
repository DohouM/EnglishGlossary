...
public class Word implements Serializable, Comparable<Word> {
	...
	/**
	 * A getter for the <code>englishWord</code> attribute of the current object,
	 * but without the mandatory asterisk.
	 * 
	 * @return the <code>englishWord</code> attribute of the current object without
	 *         the mandatory asterisk.
	 */
	public String getEnglishWordWithoutMark() {
		if (this.isMandatory()) {
			return this.englishWord.replaceAll("\\*", "");
		}
		return this.englishWord;
	}
	...
	/**
	 * A method to parse a word object from a String object <code>readLine</code>,
	 * which is a line of a CSV file.
	 * 
