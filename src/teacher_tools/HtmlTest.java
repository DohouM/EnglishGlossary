...
public class HtmlTest {
	...
	public void generateTestFile() {
		...
		String htmlOut = null;
		htmlOut = "<html style=\"text-align: center;\"><head><meta charset=\"ISO-8859-1\"></head><body><h1>Subject "
				+ this.subject + "</h1><br/><h3>Note :   /" + this.pointsValue + "</h3><br/><table>";
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "Issue while generating file... Aborting operation.", "Warning",
